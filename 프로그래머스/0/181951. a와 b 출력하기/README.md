...
<p>입력 #1</p>
<div class="highlight" bis_skin_checked="1"><pre class="codehilite"><code>4 5
</code></pre></div>
<p>출력 #1</p>
<div class="highlight" bis_skin_checked="1"><pre class="codehilite"><code>a = 4
b = 5
</code></pre></div>
